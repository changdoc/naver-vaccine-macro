# 2021-07-20 AM 10:00 새로고침 주기 3.5초 정도로 유지하고 하나의 병원 신청 페이지에서 새로 고침 하면 차단 당하지 않는다고 하네요..

# 예약 신청 페이지에서 새로고침을 일정 횟수 이상(25회정도) 시도 하면 수십분 동안 (약 1시간)
# 예약 페이지 접근이 안되도록 막히고 있어,
# 매크로를 삭제하시거나 사용하지 않을 것을 권장드립니다. -2021-07-20 AM 01:32
